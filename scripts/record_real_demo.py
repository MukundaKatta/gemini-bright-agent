"""Drive the deployed gemini-bright-agent Cloud Run app through Playwright,
...
URL = "https://gemini-bright-agent-1029931682737.us-central1.run.app/"
OUT_DIR = Path("/Users/ubl/gemini-bright-agent/.video-build")
...
def main() -> int:
    ...
    with sync_playwright() as p:
        ...
        page.wait_for_selector("text=gemini-bright-agent", timeout=60_000)
